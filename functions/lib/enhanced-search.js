...
exports.EnhancedBibleSearch = void 0;
const enhanced_bible_data_1 = require("./enhanced-bible-data");
class EnhancedBibleSearch {
    constructor() {
        this.verses = enhanced_bible_data_1.enhancedBibleVerses;
        this.keywordMappings = enhanced_bible_data_1.enhancedKeywordMappings;
    }
    /**
    ...
    search(query, limit = 10) {
        ...
        const scoredVerses = this.verses.map(verse => {
            ...
            return Object.assign(Object.assign({}, verse), { relevance_score: score.total, match_reasons: score.reasons });
     ...
     */
    calculateRelevanceScore(verse, originalQuery, searchTerms, expandedKeywords) {
        ...
        const topicMatches = verse.topics.filter(topic => searchTerms.some(term => topic.includes(term) || term.includes(topic)));
        ...
        const expandedMatches = expandedKeywords.filter(keyword => verseText.includes(keyword) && !searchTerms.includes(keyword));
...
exports.EnhancedBibleSearch = EnhancedBibleSearch;
//# sourceMappingURL=enhanced-search.js.map